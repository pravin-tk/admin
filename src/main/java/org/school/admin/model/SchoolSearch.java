...
public class SchoolSearch implements java.io.Serializable {
	...
	public SchoolSearch(int schoolId, String alias, String tagLine,
			...
			long galeryImages, long reviews, short schoolTypeId) {
	...
	public SchoolSearch(int schoolId, String name, String alias,
			...
			long reviews, String schoolType, short schoolTypeId) {
		this.schoolId = schoolId;
		this.name = name;
		this.alias = alias;
