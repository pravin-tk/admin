                        ...
                        <div class="tab-pane fade active in" id="contacts" aria-labelledby="contacts-tab">
							...
							<div id="aierror" class="bg-danger" ></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="tname" id="tname" placeholder="FootBall">
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="tooltip custom-tool-tip right">
                                            <div class="tooltip-arrow"></div>
                                            <div class="tooltip-inner">
                                                This is the name of the activity category item.
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function saveCatItem(){
	...
	if (strcat == "" ) {
		...
		$.post("../webapi/facility/activitycatitem/save", {name: $("#tname").val(),
		categoryId: $("#catId").val(), desc: $("#desc").val(), 
		status: $('input[name=status]:checked').val()}, function(data){
		if($("#catId").val() > 0){
			if(data.status == 1)
					window.location.href = "${baseUrl}/facility/activity-cat-item.jsp?scat_id="+$("#catId").val();
			else
...
function editCatItem(id){
	window.location.href = "${baseUrl}/facility/editactivity-cat-item.jsp?scatitem_id="+id;
}

$("#searchcatId").change(function(){
	if($(this).val() > 0){
		window.location.href = "${baseUrl}/facility/activity-cat-item.jsp?scat_id="+$(this).val();
	} else {
