    ...
    <div class="col-sm-3 col-md-2 sidebar">	                    
      <ul class="nav nav-sidebar">	                          
        ...
        <a href="${baseUrl}/home.jsp">          
          <i class="fa fa-bar-chart"></i>Home</a>	                          
        </li>	                          
        <!-- start general -->                 
        <div class="panel-group" id="accordion">				               
          ...
          <% if(loggedin_id == 1) {%>  
             <div class="panel-body">
		      	<a href="${baseUrl}/settings/adminuserrole.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Admin User Role</a>
		      </div>
		      <%
          }
		      %>
		       <div class="panel-body">
		      	<a href="${baseUrl}/settings/registration.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Registration </a>
		      </div>				                           
              <div class="panel-body">				                                     
          ...
          <div class="panel panel-default">				                     
            <div class="panel-heading">				                                                         
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" class="collapsed">	                  
                <i class="fa fa-gear"></i>Creation </a>				                        
            </div>				                     
            <div id="collapseTwo" class="panel-collapse collapse">				                           
		      ...
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/educationtype.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Teacher Qualification</a>
		      </div>
		      <div class="panel-body">
		      ...
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/mediumtype.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Medium of instruction</a>
		      </div>
		      <div class="panel-body">
		      ...
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/occupationtype.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Parent Occupation</a>
		      </div>
		      <div class="panel-body">
		      ...
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/role.jsp">
		      		<i class="fa fa-pencil-square-o"></i>PTC Primary Role</a>
		      </div>
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/secondaryrole.jsp">
		      		<i class="fa fa-pencil-square-o"></i>PTC Secondary Role</a>
		      </div>
		      <div class="panel-body">
		      ...
		      <div class="panel-body">
		      	<a href="${baseUrl}/settings/streamtype.jsp">
		      		<i class="fa fa-pencil-square-o"></i>Stream Type</a>
		      </div>
		       <div class="panel-body">
		      	<a href="${baseUrl}/settings/schooltype.jsp">
		      		<i class="fa fa-pencil-square-o"></i>School Type</a>
          ...
          <div class="panel panel-default">				                     
            <div class="panel-heading">				                                                         
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="collapsed">	               
                <i class="fa fa-laptop"></i>    Safety / Infrastructure  </a>				          		                     
            </div>				                     
