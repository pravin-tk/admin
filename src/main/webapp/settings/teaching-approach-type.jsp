...
List<TeachingApproachType> areaunit = settings.getTeachingApproachType();
%>               
 	<div class="col-sm-12 col-md-12  main">
    	...
    	<ol class="breadcrumb">
         	...
         	<li><a href="#">Teaching Approach Type</a>
         	</li>
        ...
        <div id="myTabContent" class="tab-content">
                 <div class="contacts-list">
                     <p>Here you can add or deactivate teaching approach type.</p>
                     <a href="#" class="btn btn-primary view-contacts bottom-margin"><i class="fa fa-plus"></i> Teaching Approach</a>
                 ...
                 <div class="contacts-new" style="display:none;">
                 	<h4>Add New Teaching Approach Type</h4>
                    <div id="error"></div>
					<form method="post" action="" class="form-horizontal" id="submitForm">
                    <div class="form-group">
                         <label class="col-sm-2 control-label">Name</label>
                         <div class="col-sm-4">
                             <input type="text" id="name" name="name" class="form-control" placeholder="e.g visual,handcrafts">
                         </div>
                         <div class="col-sm-6">
                             <div class="tooltip custom-tool-tip right">
                                 <div class="tooltip-arrow"></div>
                                 <div class="tooltip-inner">
                                     This is the name of the Teaching Approach Type. 
                                 </div>
                             </div>
                         </div>
                    </div>
    ...
    <%@include file="../footer.jsp" %>
	  <script type="text/javascript">
	    	$('#save').click(function(){    		
	    		$.post('../webapi/settings/ta/save',{name: $("#name").val()},function(data){
	    			if(data.status == 1)
			...
			function editAreaUnit(id){
				window.location.href = "${baseUrl}/settings/editteaching-approach-type.jsp?id="+id;
			}
  	</script>